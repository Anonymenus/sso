...
angular.module('MainApp.resource', [])
    .controller('resourceCtrl', ['$scope', '$state', '$stateParams','i18nService', '$loading', 'sweet', 'resourceService', function($scope, $state,$stateParams,i18nService, $loading, sweet, resourceService) {
        ...
        $scope.onSelectPage = function(page) {
            resourceService.getPages(page, $scope.pageSize, $scope.name,$scope.appId).then(function(result) {
        ...
        $scope.add = function() {
            $state.go('sso.application.resourceAdd',{'appId':$scope.appId,'parentId':$scope.parentId});
        }
